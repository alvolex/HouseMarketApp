    ...
    return (
        <div className={"container mx-auto flex-1 flex-col flex justify-center"}> 
            ...
            <div className="card shadow-2xl bg-base-100 w-4/5 md:w-1/2 mx-auto border-2 border-secondary">
                <h1 className={"mx-auto text-6xl pb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"}>Login</h1>
            ...
            <h1 className={"mx-auto text-2xl py-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent text-center"}>Don't have an account? <p onClick={()=>{navigate("/sign-up")}} className={"origin-center -rotate-[8deg] italic btn btn-secondary hover:cursor-pointer relative bottom-1  ml-4"}>Signup!</p></h1>
        </div>
    );
}
