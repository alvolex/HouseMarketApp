...
function SignIn() {
    ...
    return (
        <div className={"container mx-auto flex-1 flex-col flex justify-center"}>
                    ...
                    <div className="card-body px-6 pb-6 pt-0">
                        ...
                        <div className="form-control">
                            ...
                            <div className={"relative flex justify-end items-center"}>
                                ...
                                <input value={password} onChange={(e) => setFormData({email: email, password: e.target.value})} type="password"
                                       placeholder="Password" className="pl-8 input input-bordered w-full"/>
                            </div>
            ...
            <h1 className={"mx-auto text-2xl py-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent text-center"}>Don't
                have an account?
                <Link to={"/sign-up"}
                      className={"origin-center -rotate-[8deg] hover:rotate-[0deg] italic btn btn-secondary hover:cursor-pointer relative bottom-1  ml-4 shadow-sm shadow-primary hover:shadow-none"}>Signup!</Link>
            </h1>
        </div>
    );
}
