        ...
        <div className={"container mx-auto flex-1 flex align-middle justify-center"}>
            <div className={"w-full"}>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Link to={'/category/rent'} className="justify-self-end shadow-md rounded-b-lg rounded-t-2xl ml-4 bg-neutral group hover:border-b-primary hover:border-b-8 border-b-8 border-b-secondary max-w-sm">
                    ...
                    <Link to={'/category/sale'} className="shadow-md rounded-b-lg rounded-t-2xl mr-4 bg-neutral group hover:border-b-primary hover:border-b-8 border-b-8 border-b-secondary max-w-sm">
