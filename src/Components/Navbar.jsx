...
function Navbar() {
    ...
    return (
        <div className={"sm:max-w-[65%] flex justify-around shadow-2xl fixed bottom-0 mx-auto inset-x-0 bg-base-100 rounded-xl"}>            
           {/*EXPLORE*/}
            ...
            {/*PROFILE*/}
            <div onClick={()=>{navigate("/profile")}} className={`${pathMatchRoute('/create-listing') || pathMatchRoute('/profile') || pathMatchRoute('/sign-in') || pathMatchRoute('/sign-up') ? 'text-primary bg-base-300' : 'hover:text-secondary opacity-60 hover:opacity-100 hover:bg-base-200'} w-full p-2 flex flex-col align-middle my-2 hover:cursor-pointer  rounded-xl group items-center mx-2`}>
